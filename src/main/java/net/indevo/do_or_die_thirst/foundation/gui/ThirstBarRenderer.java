package net.indevo.do_or_die_thirst.foundation.gui;
...
public class ThirstBarRenderer
{
    ...
    public static ResourceLocation THIRST_ICONS = Do_Or_Die_Thirst.asResource("textures/gui/thirst_icons.png");
